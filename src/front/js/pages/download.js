            ...
            <div className="col-10">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <p>As reference, here is our primary CDN link: <code>{`<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Componentify-23/Componentify@main/componentify.css">`}</code></p>
                        ...
                        <p className="pe-lg-5">
                            Install Componentify's CSS Source via npm. Package managed installs don’t include documentation or our full build scripts.
                        </p>
                        
                                <div className={`c-alert c-alert-gloomy col-5 mb-5 ${copied ? "copied" : ""}`} role="alert" style={{ height: "3.5rem", width: "20rem" }}>
                                    <span style={{ marginRight: "8px" }}>
                                        $ npm install Componentify@1.0.0
                                    </span>
                                    <CopyToClipboard text="$npm install Componentify@1.0.0" onCopy={handleCopy}>
                                        <i className={`mr-2 ${copied ? "fa-solid fa-check fa-xl text-componentify" : "fa-regular fa-clipboard"} fa-xl text-fog`}></i>
                                    </CopyToClipboard>
                                </div>
                    </div>
                </div>
