...
<div className="container"  style={{ width: '100%', marginTop: '20px' }}>
      ...
      <div className="d-flex justify-content-center mt-3">
        <div
       className="c-alert c-alert-fog" role="alert"
...
>
  ...
  <path d="M6.854 4.646a.5.5 0 0 1 0 .708L4.207 8l2.647 2.646a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 0 1 .708 0zm2.292 0a.5.5 0 0 0 0 .708L11.793 8l-2.647 2.646a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708 0z"/>
      ...
      <p className="d-flex justify-content-md-start justify-content-md-center lead fw-normal">
        <a href="/docs/5.3/getting-started/download/" className="icon-link icon-link-hover fw-semibold ps-md-4">
...
<br></br>
      ...
      <div className="row">
        ...
        <div className="col-lg-6 py-lg-4 pe-lg-5" style={{ textAlign: "left", borderRight: "1px solid #ccc"}}>
          ...
          <div className="c-alert c-alert-silver" role="alert" style={{ height: "60px" }}>
